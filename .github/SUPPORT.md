...
Thank you for using `derfinderData`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/derfinderData`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/derfinderData),
...
[search issues and pull requests](https://github.com/leekgroup/derfinderData/issues)
